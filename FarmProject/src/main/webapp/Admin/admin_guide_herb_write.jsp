...
<div class="page-wrapper">
    ...
    <div class="content">
        ...
        <div class="form-box">
            ...
            <form action="admin_guide_herb_write.do" method="post" name="guide_write" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <label>카테고리</label>
                    	<input type="text" name="category" value="허브" readonly required> 
                </div>
                ...
                <div class="form-row">
	                ...
	                <div class="btn-wrap">
	                    ...
	                    <a href="admin_guide_herb_list.do" class="btn btn-cancel">취소</a>
	                </div>
