...
<div class="page-wrapper">
    ...
    <div class="content-area">
        ...
        <h1 class="board-title">🌿 공지 사항(관리자용)</h1>

        <!-- 검색창 -->
        <form name="board" method="get" action="admin_board_list.do">
                ...
                <c:forEach var="dto" items="${blist}">
                    <tr class="board-row">
                        ...
                        <td style="text-align:left; padding-left:15px;">
                            <a class="list" href="admin_board_view.do?idx=${dto.idx}&page=${page}">${dto.subject}</a>
                        </td>
                        <td>${dto.name}</td>
