...
@WebServlet("/admin_guide_veg_modify.do")
@MultipartConfig(maxFileSize = 1024 * 1024 * 10)   // 10MB 업로드 허용
public class AdminGuideVegModifyServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public AdminGuideVegModifyServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/Admin/admin_guide_veg_modify.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("admin_guide_veg_list.do");
    }
