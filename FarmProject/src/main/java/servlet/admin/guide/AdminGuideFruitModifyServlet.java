...
@WebServlet("/admin_guide_fruit_modify.do")
@MultipartConfig(maxFileSize = 1024 * 1024 * 10)   // 10MB 업로드 허용
public class AdminGuideFruitModifyServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public AdminGuideFruitModifyServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/Admin/admin_guide_fruit_modify.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("admin_guide_fruit_list.do");
    }
